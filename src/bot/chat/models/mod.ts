...
export interface ChatToolResult {
	/** ID of the plugin that was used */
	id: string;

	/** Images to display, Base64 data */
	images?: string[];

	/** Input JSON data generated by the model */
	input: object;

	/** Output JSON data passed to the model */
	output: object;

	/** Whether this tool failed to execute */
	failed: boolean;
}
